...
export default function RecipeCard({ recipe, isFavorite, onToggleFavorite, onDelete, canDelete = false, index = 0 }) {
  return (
    <motion.div
      ...
      className="group bg-gradient-to-br from-primary-50/60 to-accent-50/60 backdrop-blur-sm rounded-2xl shadow-card hover:shadow-card-hover overflow-hidden transition-all duration-300 border border-primary-100"
    >
